...
% --- NEW LEVEL DEFINITION: subsubsubsection ---
\titleclass{\subsubsubsection}{straight}[\subsubsection]
\newcounter{subsubsubsection}[subsubsection]
\renewcommand{\thesubsubsubsection}{\thesubsubsection.\arabic{subsubsubsection}}

% --- HEADING FORMATTING (Main Text) ---
...
% Indent subsubsubsections and fix overlapping numbers
\titlecontents{subsubsubsection}
  [7.5em]                                 % Horizontal indentation
  {\smallskip}                            % Vertical space
  {\contentslabel{3.8em}}                 % Width of number box (2.1.2.1)
  {}                                      % Text if no number
  {\titlerule*[0.8pc]{.}\contentspage}    % Dotted line and page number

% Fix for PDF bookmarks/sidebar
\makeatletter
