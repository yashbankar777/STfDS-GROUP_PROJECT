...
While raw AEMO market data was high-frequency, it lacked the environmental and economic features needed for predictive modelling.

Weather and economic datasets were synthetically merged using Time-stamps as primary keys. Cleaning involved linear interpolation of missing observations, removing high multi-collinear features and frequency alignments. Please refer to \appcref{app:eda} for a comprehensive \textbf{EDA}.
