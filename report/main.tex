...
The National Electricity Market (NEM) serves roughly 11 million customers across eastern Australia, with NSW being the country's largest electricity generating state \citep{aer2025som_ch2}. Demand shifts every 30 minutes with temperature, time of day, and day type, and the grid has no meaningful storage to absorb mismatches. 

The supply side is also changing. Australia ranks first globally in per capita solar electricity generation (Clean Energy Regulator [CER], 2024), with NSW holding the highest installed rooftop capacity of any state at 7.5 GW as of mid-2025 (Clean Energy Council [CEC], 2025). Rooftop solar suppresses midday grid demand but drops off sharply in late afternoon, creating a steep evening ramp that dispatchable generators must cover at short notice. NSW already sees a 34-41\% gap between its daily minimum and maximum demand, among the largest swings in the NEM (AER, 2025). 
...
The aim of this project was to determine whether machine learning models trained on historical half-hourly NSW data can predict grid electricity demand accurately enough to support operational dispatch planning. 

To support this aim, we asked: 

Does temperature have a non-linear relationship with NSW grid demand across 2°C bins from 5°C to 43°C? 

Do mean hourly demand profiles differ between weekdays, weekends, and public holidays in NSW? 

Can an ensemble regression model predict 30-minute NSW grid demand with a MAPE below 5\% on held-out test data? 
