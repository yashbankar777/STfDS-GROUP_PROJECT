...
\node[anchor=north west, xshift=1cm, yshift=-1.5cm] at (current page.north west) {
    \includegraphics[width=4.2cm]{img/uts_logo_white.png}
};
...
\node[
    ...
    \color{white}
    {\fontsize{24}{28}\selectfont\bfseries Assignment 2: \\ Data Analysis Report}
};
...
\node[
    ...
    \color{white}
    {\fontsize{12}{14}\selectfont 36103: Statistical Thinking for Data Science}
};

% Semi-transparent box - Now anchored to the BOTTOM
\node[
    anchor=south west,    % Anchors to the bottom-left
    align=left,
    fill=white,
    fill opacity=0.9,
    text opacity=1,
    inner sep=15pt,
    rounded corners=2pt,
    xshift=1.2cm,           % Stays aligned horizontally with the title
    yshift=1.5cm          % Distance UP from the bottom edge
] at (current page.south west) {
    \color{black}
    {\fontsize{12}{16}\selectfont \textbf{Group Number:} 5} \\[0.2cm]
